          ...
          <View style={{}}>
            <View style={{marginTop: 10}}>
              <Image
                ...
                source={require('../Image/newof.png')}
                resizeMode="contain"
              />
            </View>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Image
              ...
              source={require('../Image/trelgram.png')}
              resizeMode="contain"
            />
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <View
              style={{backgroundColor: 'white', borderRadius: 30, padding: 4}}>
              <Image
                style={{width: 13, height: 13}}
                source={require('../Image/Srch.png')}
                resizeMode="contain"
              />
            </View>
            <Text style={{color: '#fff', fontSize: 15.4, fontWeight: '700'}}>
              SEARCHER
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <Image
              style={{width: 35, height: 35}}
              source={require('../Image/Downlodd.png')}
              resizeMode="contain"
            />
          </TouchableOpacity>
